...
public class SodiumConversionsTest extends BaseTest {
    ...
    public void base64Conversion() {
        ...
        int maxLen = lazySodium.getSodium().sodium_base64_encoded_len(10, 7);
        byte[] base64 = new byte[maxLen];
        lazySodium.getSodium().sodium_bin2base64(base64, maxLen, bin, bin.length, 7);
        ...
        lazySodium.getSodium().sodium_base642bin(
                reconstructedBin,
                reconstructedMaxLen,
                base64,
                base64.length,
    ...
    public void hesConversion() {
        ...
        lazySodium.getSodium().sodium_bin2hex(
                hex,
                hexLen,
                bin,
                bin.length
        ...
        lazySodium.getSodium().sodium_hex2bin(
                reconstructedBin,
